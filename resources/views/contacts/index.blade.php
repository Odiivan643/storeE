...
<div class="">
    ...
    <div class="form-check form-switch">
        <input name="isValidated" id="isValidated" data-id="{{$contact->id}}" value="true" data-bs-toggle="toggle"  {{ isset($contact) && $contact->isValidated == 'true' ? 'checked' : '' }} class="form-check-input" type="checkbox" role="switch" />
    </div>
</td>
						<td>
