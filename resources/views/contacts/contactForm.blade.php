        ...
        <div class="col-md-8">
            <form
                ...
                <div class="mb-3 d-flex gap-2">
                    <label for="isValidated" class="form-label">IsValidated</label>
                    <div class="form-check form-switch">
                        <input name="isValidated" id="isValidated" value="true" data-bs-toggle="toggle"
                            {{ old('isValidated', isset($contact) && $contact->isValidated == 'true' ? 'checked' : '') }}
                            class="form-check-input" type="checkbox" role="switch" />
                    </div>
                    {{-- <select class="form-control" name="isValidated" id="isValidated">
            <option value="true" {{ old('isValidated', isset($contact) && $contact->isValidated == 'true' ? 'selected' : '') }}>Yes</option>
            <option value="false" {{ old('isValidated', isset($contact) && $contact->isValidated == 'false' ? 'selected' : '') }}>No</option>
        </select> --}}
