    ...
    <div class="row">
        <div class="col-md-12">
            <form class="row"
                ...
                <div class="mb-3">
                    <textarea name="content" placeholder="Content ..." class="form-control" id="content" aria-describedby="contentHelp">{{ old('content', isset($contact) ? $contact->content : '') }}</textarea>
                ...
                <div class="col-md-12 mb-3">
                    <button class="btn btn-primary"> {{ isset($contact) ? 'Update' : 'Send Message' }}</button>
                </div>
            </form>
        </div>
        {{-- <div class="col-md-4">
