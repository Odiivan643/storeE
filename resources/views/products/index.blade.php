...
<div class="">
            ...
            <thead>
                <tr>
                    <th scope="col">N#</th>
						...
						<th scope="col">IsIphone</th>
						<th scope="col">IsSamsung</th>
						<th scope="col">IsHuawei</th>
    ...
    <div class="form-check form-switch">
        <input name="isIphone" id="isIphone" data-id="{{$product->id}}" value="true" data-bs-toggle="toggle"  {{ isset($product) && $product->isIphone == 'true' ? 'checked' : '' }} class="form-check-input" type="checkbox" role="switch" />
    </div>
</td>
							    <td>
    <div class="form-check form-switch">
        <input name="isSamsung" id="isSamsung" data-id="{{$product->id}}" value="true" data-bs-toggle="toggle"  {{ isset($product) && $product->isSamsung == 'true' ? 'checked' : '' }} class="form-check-input" type="checkbox" role="switch" />
    </div>
</td>
							    <td>
    <div class="form-check form-switch">
        <input name="isHuawei" id="isHuawei" data-id="{{$product->id}}" value="true" data-bs-toggle="toggle"  {{ isset($product) && $product->isHuawei == 'true' ? 'checked' : '' }} class="form-check-input" type="checkbox" role="switch" />
    </div>
</td>
							    <td>
    <div class="form-check form-switch">
