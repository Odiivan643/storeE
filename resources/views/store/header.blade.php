                ...
                <div id="navbarSupportedContent" class="navbar-collapse justify-content-end collapse" style="">
                    <ul class="navbar-nav">
                        <li class="dropdown"><a routerlink="/" class="nav-link" ng-reflect-router-link="/"
                                href="/"><strong>Acceuil</strong></a></li>
                        <li class="dropdown"><a href="#" data-bs-toggle="dropdown"
                                class="dropdown-toggle nav-link active" aria-expanded="false">Pages</a>
                            <div class="dropdown-menu">
                                @auth
                                <ul>
                                    {{-- <li><a routerlink="/about" class="dropdown-item nav-link nav_item"
                                            ng-reflect-router-link="/about" href="/about">About Us</a></li> --}}
                                    <li><a routerlink="/contact" class="dropdown-item nav-link nav_item"
                                            ng-reflect-router-link="/contact" href="/contact"><strong>Contact-Nous</strong></a></li>
                                    <li ><a  routerlink="/dashboard"
                                            class="dropdown-item nav-link nav_item" ng-reflect-router-link="/dashboard"
                                            href="/dashboard"><strong>Dashboard</strong></a></li>
                                    {{-- <li><a routerlink="/terms" class="dropdown-item nav-link nav_item"
                                            ng-reflect-router-link="/terms" href="/terms">Terms and Conditions</a></li> --}}
                                </ul>
                                @endauth
                            </div>
                        </li>
                        ...
                        {{-- <li  class="dropdown dropdown-mega-menu"><a
                                 routerlink="/Products" class="nav-link"
                                 href="/Products">Products</a></li> --}}
                                 @auth
                                 <li><a routerlink="/contact" class="nav-link nav_item" ng-reflect-router-link="/contact"
                                    href="/contact"><strong>Contactez-nous</strong>
                                    </a></li>
                                @else
                                <li><a routerlink="/signin" class="dropdown-item nav-link nav_item"
                                    ng-reflect-router-link="/signin" href="{{ route('login') }}"><strong>Connexion</strong></a></li>
                            <li><a routerlink="/signup" class="dropdown-item nav-link nav_item"
                                    ng-reflect-router-link="/signup" href="{{ route('register') }}"><strong>Inscription</strong></a>
                            </li>
                                ...
                                @if (auth()->user()->isAdmin())
                                    <li><a href="{{ route('admin.user.index') }}" class="nav-link nav_item"><strong>Admin</strong></a></li>
                                @endif
                            @endauth
                            ...
                            <div class="cart_footer">
                                ...
                                <p class="cart_buttons">
                                    <a routerlink="/cart" class="btn btn-fill-line view-cart"
                                        ng-reflect-router-link="/cart" href="/cart">View Cart</a>
                                        {{-- <a
